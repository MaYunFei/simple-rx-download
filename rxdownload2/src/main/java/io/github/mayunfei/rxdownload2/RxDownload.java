package io.github.mayunfei.rxdownload2;
...
import io.github.mayunfei.rxdownload2.entity.DownloadBean;
import io.github.mayunfei.rxdownload2.entity.DownloadEvent;
import io.github.mayunfei.rxdownload2.entity.DownloadRecord;
import io.github.mayunfei.rxdownload2.entity.DownloadStatus;
import io.github.mayunfei.rxdownload2.entity.MultiMission;
import io.github.mayunfei.rxdownload2.entity.SingleMission;
import io.github.mayunfei.rxdownload2.function.DownloadHelper;
import io.github.mayunfei.rxdownload2.function.DownloadService;
import io.github.mayunfei.rxdownload2.function.Utils;
...
import static io.github.mayunfei.rxdownload2.function.Utils.log;
...
public class RxDownload {
   ...
   * @return Files
   */
  @Nullable public File[] getRealFiles(String url) {
  ...
  public Observable<DownloadStatus> download(String url, String saveName, String savePath) {
    return download(
        new DownloadBean.Builder(url).setSaveName(saveName).setSavePath(savePath).build());
  }
  ...
  public <Upstream> ObservableTransformer<Upstream, DownloadStatus> transform(
    ...
    return new ObservableTransformer<Upstream, DownloadStatus>() {
      @Override public ObservableSource<DownloadStatus> apply(Observable<Upstream> upstream) {
        return upstream.flatMap(new Function<Upstream, ObservableSource<DownloadStatus>>() {
          @Override public ObservableSource<DownloadStatus> apply(Upstream upstream)
              throws Exception {
  ...
  public <Upstream> ObservableTransformer<Upstream, Object> transformService(
      final DownloadBean bean) {
    return new ObservableTransformer<Upstream, Object>() {
      @Override public ObservableSource<Object> apply(Observable<Upstream> upstream) {
        return upstream.flatMap(new Function<Upstream, ObservableSource<?>>() {
          @Override public ObservableSource<?> apply(Upstream upstream) throws Exception {
   ...
   * @return Observable<DownloadStatus>
   */
  public Observable<?> serviceMultiDownload(final List<DownloadBean> beans,
   ...
   * @return Transformer
   */
  public <Upstream> ObservableTransformer<Upstream, Object> transformMulti(String missionId,
      String... urls) {
